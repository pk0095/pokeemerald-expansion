...
#define P_FLAG_EGG_MOVES                 FLAG_SUMMARY_EGG_MOVE_RELEARNER       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               FLAG_SUMMARY_TUTOR_MOVE_RELEARNER     // If this flag is set, enables tutor move relearner.
